...
class DefaultEngineConfig:
    ...
    def init_dir(self):
        ...
        self.DIR_DAVIS = os.path.join(self.DIR_DATA)
        self.DIR_YTB = os.path.join(
            self.DIR_DATA,
        )
        self.DIR_STATIC = os.path.join(self.DIR_DATA)

        self.DIR_ROOT = "./"  #'./data_wd/youtube_vos_jobs'

        self.DIR_RESULT = os.path.join(self.DIR_ROOT, ".")
        self.DIR_CKPT = os.path.join(self.DIR_RESULT)
        self.DIR_EMA_CKPT = os.path.join(self.DIR_RESULT)
        self.DIR_LOG = os.path.join(self.DIR_RESULT)
        self.DIR_TB_LOG = os.path.join(self.DIR_RESULT)
